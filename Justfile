...
# Justfile for format-registrations
...
doctor:
    @echo "Running diagnostics for format-registrations..."
...
tour:
    @echo "=== format-registrations Tour ==="
    @echo ""
...
help-me:
    @echo "=== format-registrations Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/format-registrations/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: format-registrations"
