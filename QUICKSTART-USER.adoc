= Format Registrations — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/format-registrations
cd format-registrations
...
* https://github.com/hyperpolymath/format-registrations/issues — report bugs
